...
png(file = 'plot4.png')
par(mfrow=c(2,2))
plot(sub$Date2,sub$Global_active_power,type="l",ylab='Global Active Power',xlab="")
plot(sub$Date2,sub$Voltage,type='l',ylab='Voltage',xlab='')
with(sub,{
...
plot(sub$Date2,sub$Global_reactive_power,type='l',ylab='Global Reactive Power',xlab='')
dev.off()